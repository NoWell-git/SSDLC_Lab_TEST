...
CREATE TABLE components (
    ...
    category_id INT REFERENCES categories(id) ON DELETE CASCAD>
...
CREATE TABLE compatibility (
    ...
    motherboard_id INT REFERENCES components(id) ON DELETE CAS>
    socket VARCHAR(20),
...
-- Тестовые данные
INSERT INTO categories (name) VALUES ('CPU'), ('Motherboard'),>
INSERT INTO manufacturers (name, country) VALUES ('Intel', 'US>
INSERT INTO components (name, category_id, manufacturer_id, mo>
